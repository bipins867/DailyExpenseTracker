...
function addItem(obj){
    ...
    deleteButton.addEventListener('click',event=>{
        ...
        axios.get(`http://13.48.93.108:3000/Expense/getDeleteExpense/${obj.id}`,{headers})
        .then(result=>{
            console.log(result)
            list.removeChild(li)
        })
...
const addFunction=async event=>{
    ...
    try{
        ...
        const result=await axios.post('http://13.48.93.108:3000/Expense/postAddExpense/',obj,{headers:{Authorization:token}})
...
async function getExpenseByPage(page){
    ...
    const result=await axios.get(`http://13.48.93.108:3000/Expense/getExpenseByPage/${page}`,{headers})
...
async function getProducts(){
    ...
    window.location.href='../Login/index.html'
    const headers={authorization:token}
    const result=await axios.get('http://13.48.93.108:3000/Expense/getExpenses',{headers})
...
buttonPremium.onclick=async event=>{
    ...
    window.location.href='../Login/index.html'
    const headers={authorization:token}
    const result=await axios.get('http://13.48.93.108:3000/Purchase/createOrder',{headers})
    ...
    const option={
        ...
        handler:async response=>{
            ...
            axios.post('http://13.48.93.108:3000/Purchase/updateTransactionStatus',opt,{headers})
            .then(res=>{
...
buttonShowLeaderboard.onclick=async event=>{
    ...
    window.location.href='../Login/index.html'
    const headers={authorization:token}
    const result=await axios.get('http://13.48.93.108:3000/Premium/showLeaderboard',{headers})
...
buttonDownload.onclick=async event=>{
    ...
    try
    {
        const result=await axios.get('http://13.48.93.108:3000/User/download',{headers})
        console.log(result)
